# Define variables for name, course, year, and section
full_name = "Mark Vince Alfred U. Fernandez"
...
# Create two variables
number = 42           # Assigning a number to the variable 'number'
name = "Alice"       # Assigning a name to the variable 'name'
...
name, age, course = "Mark Vince", 24, "BSCS"
